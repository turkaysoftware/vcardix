...
## 🔍 Before You Begin
1.  **Search Existing Issues:** Before opening a new issue, please search the [Issues](https://github.com/turkaysoftware/vcardix/issues) tab to see if the topic has already been discussed or reported.
